...
/* USER CODE BEGIN EFP */
void set_configuration(acc_service_configuration_t);
void print_data(uint16_t*, uint16_t);
int peak_index(uint16_t*, uint16_t);
/* USER CODE END EFP */
...
#define PROFILE								ACC_SERVICE_PROFILE_1
